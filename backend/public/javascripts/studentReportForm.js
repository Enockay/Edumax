...
const { updateStudentPdfs } = require('./updateReportForm'); // Updated function to handle multiple students
...
const generateReportform = async (year, stream, term, examType) => {
  try {
    ...
    const concurrency = 50; // Adjust concurrency level as needed
                  ...
                  <div class="student-details">
                    <table class="details-table">
                      ...
                      <tr>
                        ...
                        <th>STREAM RANK</th>
                        <td>${student.years[0].exams[0].streamRank||''}</td>
                        <th></th>
                        <td></td>
                      </tr>
                    </table>
   ...
   //console.log("The pdf updates",pdfUpdates);
      await updateStudentPdfs(pdfUpdates, batchSize, concurrency);
    }
