...
import { FaTachometerAlt, FaUser, FaClipboardList, FaCalendarCheck, FaSchool, FaEnvelope, FaMoneyCheckAlt, FaLifeRing } from 'react-icons/fa';
...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, toggleSidebar }) => {
  return (
    <aside className={`fixed top-16 bottom-16 left-0 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 w-48 bg-gray-800 text-white p-4 space-y-4 transition-transform duration-200 ease-in-out overflow-y-scroll`}>
      <nav>
        <hr className={"m-4"}></hr>
        {/* Academics Section */}
        <div className="mb-4">
